...
const Section3 = (props) => {
    ...
    let Cards = [
        <ProjectCard key={0} active={page === 0} background={NTDF} centered={true} title="Nature TD: Forest" description="3D Unity Game" info="Nature TD: Forest is a 3D, First Person, Tower Defense Game Made In Unity. The Game Has many modular Scripts which make adding new features and levels very easy. There is currently 1 playable level and 9 different towers" buttons={[{name: "Play Demo", url: null, func: () => console.log("x")}, {name: "Github", url: "https://github.com", func: null}]} modal={null} />,
        <ProjectCard key={1} active={page === 1} background={SAU} centered={false} title="Steam Achievement Unlocker" description="JavaScript Desktop App" info="3D GAME" buttons={[{name: "Play Demo", func: () => console.log("x"), url: "https://google.com"}]} modal={null} />,
        <ProjectCard key={2} active={page === 2} background={VR} centered={true} title="Vertical Runner" description="2D Unity Game" info="3D GAME" buttons={[{name: "Play Demo", func: () => console.log("x"), url: "https://google.com"}]} modal={null} />,
