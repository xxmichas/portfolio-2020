...
const Section3 = (props) => {
    ...
    let Cards = [
        ...
        <ProjectCard key={3} active={page === 3} background={Server} centered={false} title="Web Server in Node.js" description="HTTP Server With Authentication And Tokens" info="3D GAME" buttons={[{name: "Github", func: null, url: "https://github.com/xxmichas/http-login-with-tokens"}]} />,
        <ProjectCard key={4} active={page === 4} background={Portfolio} centered={true} title="Portfolio Website in React" description="My Portfolio Website Built With React" info="3D GAME" buttons={[{name: "Github", func: null, url: "https://github.com/xxmichas/portfolio"}]} />,
        <ProjectCard key={5} active={page === 5} background={Bot} centered={true} title="Discord bot in Node.js" description="Discord Bot Using Discord.js Library" info="3D GAME" buttons={[{name: "Github", func: null, url: "https://github.com/xxmichas/boy-bot"}]} />
    ]
